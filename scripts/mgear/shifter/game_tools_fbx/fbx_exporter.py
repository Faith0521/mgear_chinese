...
class FBXExporter(MayaQWidgetDockableMixin, QtWidgets.QDialog):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Shifter FBX导出")
        min_w = 300
        default_w = 400
        default_h = 1000
    ...
    def create_source_elements_widget(self):
        ...
        self.geo_auto_set_btn = create_button(geo_buttons_layout, label="自动")
        geo_buttons_layout.addStretch()
    ...
    def create_settings_widget(self):
        ...
        fbx_version_label = QtWidgets.QLabel("FBX 版本")
        ...
        fbx_preset_label = QtWidgets.QLabel("FBX 预设")
        ...
        settings_tab.addTab(fbx_sdk_tab, "FBX 预处理")
    ...
    def create_file_path_widget(self):
        # main collapsible widget layout
        file_path_collap_wgt = widgets.CollapsibleWidget("文件路径")
        ...
        file_name_label = QtWidgets.QLabel("文件名")
    ...
    def create_unreal_import_widget(self):
        ...
        self.ue_import_cbx = QtWidgets.QCheckBox("启用虚幻引擎导入")
        ...
        ue_skeleton_label = QtWidgets.QLabel("UE 骨骼")
    ...
    def create_export_widget(self):
        export_collap_wgt = widgets.CollapsibleWidget("导出")
    ...
    def create_skeletal_mesh_tab(self):
        ...
        self.export_tab.addTab(skeletal_mesh_tab, "骨骼网格体")
        ...
        # deformers options
        deformers_label = QtWidgets.QLabel("变形器")
        ...
        self.skinning_checkbox = QtWidgets.QCheckBox("蒙皮")
        self.skinning_checkbox.setChecked(True)
        self.blendshapes_checkbox = QtWidgets.QCheckBox("混合变形")
        self.blendshapes_checkbox.setChecked(True)
        self.partitions_checkbox = QtWidgets.QCheckBox("分区")
        self.partitions_checkbox.setChecked(True)
        self.culljoints_checkbox = QtWidgets.QCheckBox("剔除关节")
        ...
        # partitions layout
        self.partitions_label = QtWidgets.QLabel("分区")
    ...
    def create_animation_tab(self):
        ...
        self.export_tab.addTab(animation_tab, "动画")
        ...
        self.anim_export_btn = QtWidgets.QPushButton("导出动画")
