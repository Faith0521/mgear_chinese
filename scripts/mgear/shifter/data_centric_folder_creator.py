...
class FolderStructureCreatorUI(MayaQWidgetDockableMixin, QtWidgets.QDialog):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("数据中心文件夹结构创建器")
    ...
    def create_actions(self):
        self.import_action = QtWidgets.QAction("导入配置")
        self.export_action = QtWidgets.QAction("导出配置")
    ...
    def init_ui(self):
        ...
        self.create_btn = QtWidgets.QPushButton("创建文件夹结构")
        ...
        folder_names_layout.addWidget(QtWidgets.QLabel("自定义步骤文件夹:"))
        folder_names_layout.addWidget(self.custom_step_name_le)
        folder_names_layout.addWidget(QtWidgets.QLabel("数据文件夹:"))
        ...
        settings_layout.addWidget(QtWidgets.QLabel("类型:"))
        settings_layout.addWidget(self.type_le)
        settings_layout.addWidget(QtWidgets.QLabel("名称:"))
        settings_layout.addWidget(self.name_le)
        settings_layout.addWidget(QtWidgets.QLabel("变体:"))
        settings_layout.addWidget(self.variant_le)
        settings_layout.addWidget(QtWidgets.QLabel("目标:"))
        settings_layout.addWidget(self.target_le)
        settings_groupbox = QtWidgets.QGroupBox("设置")
