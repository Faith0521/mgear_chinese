...
class Ui_Form(object):
    ...
    def setupUi(self, Form):
        ...
        self.side_comboBox.addItem("居中")
        self.side_comboBox.addItem("左侧")
        self.side_comboBox.addItem("右侧")
