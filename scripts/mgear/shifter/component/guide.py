...
class componentMainSettings(QtWidgets.QDialog, guide.helperSlots):
    ...
    def _create_blueprint_header(self):
        ...
        self.blueprint_indicator.setToolTip("蓝图已在此组件上激活")
        ...
        self.blueprint_view_pushButton = QtWidgets.QPushButton("视图")
        self.blueprint_view_pushButton.setObjectName("blueprint_view_pushButton")
        self.blueprint_view_pushButton.setToolTip("查看蓝图设置")
