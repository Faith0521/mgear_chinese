...
class Ui_Form(object):
    ...
    def setupUi(self, Form):
        ...
        self.rigName_label.setText("骨骼名称")
        ...
        self.mode_comboBox.addItem("最终")
        self.mode_comboBox.addItem("制作中")
        ...
        self.step_comboBox.addItem("所有步骤")
        self.step_comboBox.addItem("对象")
        self.step_comboBox.addItem("属性")
        self.step_comboBox.addItem("操作器")
        self.step_comboBox.addItem("连接")
        self.step_comboBox.addItem("关节")
        self.step_comboBox.addItem("完成")
        ...
        self.classicChannelNames_checkBox.setText("使用经典通道名称（所有通道将有唯一名称。）")
        ...
        self.attrPrefix_checkBox.setText("使用组件实例名称作为属性前缀")
        ...
        self.groupBox_7.setTitle("基础骨骼控制")
        ...
        self.jointRig_checkBox.setText("分离关节结构")
        ...
        self.jointWorldOri_checkBox.setText("强制世界朝向")
        ...
        self.force_uniScale_checkBox.setText("通过将所有轴连接到Z轴来强制所有关节统一缩放")
        ...
        self.connect_joints_checkBox.setText("连接到现有关节。")
        ...
        self.dataCollectorEmbbeded_label.setText("自定义关节或变换节点")
