...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.override_namingRules_checkBox.setText("本地覆盖: 命名规则")
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox_8.setTitle(gqt.fakeTranslate("Form", "控制器命名规则", None, -1))
        ...
        self.reset_ctl_name_rule_pushButton.setText(gqt.fakeTranslate("Form", "重置", None, -1))
        self.label.setText(gqt.fakeTranslate("Form", "{描述} 大小写", None, -1))
        self.ctl_des_letter_case_comboBox.setItemText(0, gqt.fakeTranslate("Form", "默认", None, -1))
        self.ctl_des_letter_case_comboBox.setItemText(1, gqt.fakeTranslate("Form", "大写", None, -1))
        self.ctl_des_letter_case_comboBox.setItemText(2, gqt.fakeTranslate("Form", "小写", None, -1))
        self.ctl_des_letter_case_comboBox.setItemText(3, gqt.fakeTranslate("Form", "首字母大写", None, -1))
        self.groupBox_9.setTitle(gqt.fakeTranslate("Form", "关节命名规则", None, -1))
        ...
        self.reset_joint_name_rule_pushButton.setText(gqt.fakeTranslate("Form", "重置", None, -1))
        self.label_3.setText(gqt.fakeTranslate("Form", "{描述} 大小写", None, -1))
        self.joint_des_letter_case_comboBox.setItemText(0, gqt.fakeTranslate("Form", "默认", None, -1))
        self.joint_des_letter_case_comboBox.setItemText(1, gqt.fakeTranslate("Form", "大写", None, -1))
        self.joint_des_letter_case_comboBox.setItemText(2, gqt.fakeTranslate("Form", "小写", None, -1))
        self.joint_des_letter_case_comboBox.setItemText(3, gqt.fakeTranslate("Form", "首字母大写", None, -1))
        self.groupBox_10.setTitle(gqt.fakeTranslate("Form", "控制器侧命名", None, -1))
        self.label_4.setText(gqt.fakeTranslate("Form", "左侧", None, -1))
        ...
        self.label_5.setText(gqt.fakeTranslate("Form", "右侧", None, -1))
        ...
        self.label_6.setText(gqt.fakeTranslate("Form", "居中", None, -1))
        ...
        self.reset_side_name_pushButton.setText(gqt.fakeTranslate("Form", "重置", None, -1))
        self.groupBox_12.setTitle(gqt.fakeTranslate("Form", "关节侧命名", None, -1))
        self.label_9.setText(gqt.fakeTranslate("Form", "左侧", None, -1))
        ...
        self.label_10.setText(gqt.fakeTranslate("Form", "右侧", None, -1))
        ...
        self.label_11.setText(gqt.fakeTranslate("Form", "居中", None, -1))
        ...
        self.reset_joint_side_name_pushButton.setText(gqt.fakeTranslate("Form", "重置", None, -1))
        self.groupBox_13.setTitle(gqt.fakeTranslate("Form", "索引填充", None, -1))
        self.label_12.setText(gqt.fakeTranslate("Form", "控制器", None, -1))
        self.label_13.setText(gqt.fakeTranslate("Form", "关节", None, -1))
        self.groupBox_11.setTitle(gqt.fakeTranslate("Form", "扩展名命名", None, -1))
        self.label_7.setText(gqt.fakeTranslate("Form", "控制器", None, -1))
        ...
        self.label_8.setText(gqt.fakeTranslate("Form", "关节", None, -1))
        ...
        self.reset_name_ext_pushButton.setText(gqt.fakeTranslate("Form", "重置", None, -1))
        self.load_naming_configuration_pushButton.setText(gqt.fakeTranslate("Form", "加载", None, -1))
        self.save_naming_configuration_pushButton.setText(gqt.fakeTranslate("Form", "保存", None, -1))
