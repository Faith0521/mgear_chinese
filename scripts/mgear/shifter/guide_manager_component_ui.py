...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.settings_pushButton.setWhatsThis(gqt.fakeTranslate("Form", "<html><head/><body><p>打开组件/引导根节点设置窗口。</p></body></html>", None, -1))
        ...
        self.build_pushButton.setToolTip(gqt.fakeTranslate("Form", "<html><head/><body><p>从选择构建骨骼</p></body></html>", None, -1))
        self.build_pushButton.setWhatsThis(gqt.fakeTranslate("Form", "<html><head/><body><p>打开组件/引导根节点设置窗口。</p></body></html>", None, -1))
