...
class GuideVisualizerUI(MayaQWidgetDockableMixin, QtWidgets.QDialog):
    ...
    def _build_ui(self):
        ...
        self.display_curves_section = CollapsibleWidget("显示曲线")
        self.create_btn = QtWidgets.QPushButton("从选择创建")
        self.select_btn = QtWidgets.QPushButton("全选")
        self.mirror_btn = QtWidgets.QPushButton("镜像曲线")
        ...
        self.apply_thickness_btn = QtWidgets.QPushButton("应用到全部")
        disp_thickness_layout.addWidget(QtWidgets.QLabel("宽度:"))
        ...
        toggle_layout.addWidget(QtWidgets.QLabel("状态:"))
        self.toggle_display_type_btn = QtWidgets.QPushButton("切换")
        ...
        self.selected_curves_section = CollapsibleWidget("选中曲线")
        ...
        # Thickness row
        sel_layout.addWidget(QtWidgets.QLabel("厚度:"), 0, 0)
        ...
        # CV Scale row
        sel_layout.addWidget(QtWidgets.QLabel("CV 缩放:"), 1, 0)
        ...
        self.curve_colors_section = CollapsibleWidget("曲线颜色")
        ...
        self.color_button = QtWidgets.QPushButton("拾取颜色")
        self.color_button.setFixedHeight(25)
        self.pick_from_sel_button = QtWidgets.QPushButton("从选择获取")
        ...
        history_layout.addWidget(QtWidgets.QLabel("历史:"))
        ...
        self.apply_color_button = QtWidgets.QPushButton("应用")
        ...
        offset_layout.addWidget(QtWidgets.QLabel("偏移 X:"), 0, 0)
        offset_layout.addWidget(self.offset_x_spin, 0, 1)
        offset_layout.addWidget(QtWidgets.QLabel("偏移 Y:"), 1, 0)
        offset_layout.addWidget(self.offset_y_spin, 1, 1)
        offset_layout.addWidget(QtWidgets.QLabel("偏移 Z:"), 2, 0)
        ...
        self.add_label_btn = QtWidgets.QPushButton("添加到所选")
        self.remove_label_btn = QtWidgets.QPushButton("从所选移除")
        ...
        self.remove_all_labels_btn = QtWidgets.QPushButton("全部移除")
        self.toggle_labels_btn = QtWidgets.QPushButton("切换可见性")
