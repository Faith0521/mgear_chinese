...
def mocap_submenu(parent_menu_id):
    ...
    commands = (
        ...
        ("角色化双足(旧版)", str_mocap_characterizeBiped),
...
def game_submenu(parent_menu_id):
    ...
    """
    commands = (
        ("FBX 导出", str_game_fbx_export),
        ("-----", None),
        ("断开关节", str_game_disconnet),
        ("连接关节", str_game_connect),
        ("删除绑定保留关节", str_game_delete_rig),
        ("-----", None),
        ("游戏工具断开 + 程序集 IO", str_openGameAssemblyTool),
    )
...
def guide_template_samples_submenu(parent_menu_id):
    ...
    """
    commands = (
        ("双足模板, Y轴向上", str_biped_template),
        ("四足模板, Y轴向上", str_quadruped_template),
        ("游戏双足模板, Y轴向上", str_game_biped_template),
        ("-----", None),
        ("UE5 MetaHuman/Manny模板, Y轴向上", str_epic_metahuman_y_template),
        ("UE5 MetaHuman/Manny模板, Z轴向上", str_epic_metahuman_z_template),
        ("UE4 Mannequin模板, Y轴向上", str_epic_mannequin_y_template),
        ("UE4 Mannequin模板, Z轴向上", str_epic_mannequin_z_template),
        ("-----", None),
        ("UE MetaHuman/Manny对齐", str_epic_metahuman_snap),
        ("-----", None),
        ("蜘蛛", str_spider_template),
        ("长颈鹿", str_giraffe_template),
        ("螳螂", str_mantis_template),
        ("霸王龙", str_trex_template),
    )
