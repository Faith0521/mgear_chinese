...
class Ui_Form(object):
    ...
    def setupUi(self, Form):
        ...
        self.override_preCustomSteps_checkBox.setText("本地覆盖: 前置自定义步骤")
        ...
        self.override_postCustomSteps_checkBox.setText("本地覆盖: 后置自定义步骤")
...
class TemplateSelectionDialog(QtWidgets.QDialog):
    ...
    def _setup_ui(self):
        ...
        template_label = QtWidgets.QLabel("模板:")
...
class CustomStepErrorDialog(QtWidgets.QDialog):
    ...
    def _setup_ui(self, step_path, error_type, error_args, traceback_text):
        ...
        title_label = QtWidgets.QLabel("自定义步骤失败")
        ...
        # Question label
        question_label = QtWidgets.QLabel("是否继续下一步?")
        ...
        continue_btn = QtWidgets.QPushButton("继续")
        continue_btn.setMinimumWidth(100)
        continue_btn.clicked.connect(self._on_continue)
        button_layout.addWidget(continue_btn)

        stop_btn = QtWidgets.QPushButton("停止构建")
...
class GroupSelectionDialog(QtWidgets.QDialog):
    ...
    def _setup_ui(self):
        ...
        select_none_btn = QtWidgets.QPushButton("全不选")
