...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox_2.setTitle(gqt.fakeTranslate("Form", "主引导模板", None, -1))
        self.load_pushButton.setText(gqt.fakeTranslate("Form", "...", None, -1))
        self.groupBox.setTitle(gqt.fakeTranslate("Form", "差异测试选项", None, -1))
        self.missingGuide_checkBox.setText(gqt.fakeTranslate("Form", "缺失的引导组件", None, -1))
        self.extraGuide_checkBox.setText(gqt.fakeTranslate("Form", "多余的引导组件", None, -1))
        self.transform_checkBox.setText(gqt.fakeTranslate("Form", "组件变换", None, -1))
        self.rootSettings_checkBox.setText(gqt.fakeTranslate("Form", "根设置", None, -1))
        self.compSettings_checkBox.setText(gqt.fakeTranslate("Form", "组件设置", None, -1))
        self.customStep_checkBox.setText(gqt.fakeTranslate("Form", "自定义步骤", None, -1))
        self.runTest_pushButton.setText(gqt.fakeTranslate("Form", "运行差异测试", None, -1))
