...
class ChannelTable(QtWidgets.QTableWidget):
    ...
    def create_menu(self):
        ...
        reset_value_action = QtWidgets.QAction("重置为默认值", self)
        ...
        auto_color_host_action = QtWidgets.QAction("按宿主自动着色", self)
        ...
        auto_color_axis_action = QtWidgets.QAction("按轴向自动着色", self)
    ...
    def create_key_button(self, item_data):
        ...
        remove_animation_action = QtWidgets.QAction("移除动画", button)
