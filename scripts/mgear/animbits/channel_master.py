...
class ChannelMaster(
    ...
    def create_actions(self):
        # file actions
        self.file_new_node_action = QtWidgets.QAction("新建节点", self)
        ...
        self.display_order_default_action = QtWidgets.QAction("默认", self)
        ...
        # Tabs Actions
        self.tab_new_action = QtWidgets.QAction("新建标签页", self)
        self.tab_new_action.setIcon(pyqt.get_icon("mgear_menu"))
        self.tab_del_action = QtWidgets.QAction("删除当前标签页", self)
        self.tab_del_action.setIcon(pyqt.get_icon("mgear_trash-2"))
        self.tab_dup_action = QtWidgets.QAction("复制标签页", self)
        self.tab_dup_action.setIcon(pyqt.get_icon("mgear_copy"))
        self.tab_rename_action = QtWidgets.QAction("重命名标签页", self)
    ...
    def create_widgets(self):
        ...
        self.display_menu.addSeparator()
        self.order_menu = self.display_menu.addMenu("排序")
