    ...
    def set_list_of_bones_from_selection(
        ...
        if do_mirror:
            if "Left" in bones_list[0]:
                bones_list.extend(
                    [bone.replace("Left", "右侧") for bone in bones_list]
                )
                ctrls.extend(
                    [
                ...
                bones_list.extend(
                    [bone.replace("Right", "左侧") for bone in bones_list]
                )
                ctrls.extend(
                    [
                        MirrorController.get_opposite_control(ctrl)
...
class HumanIKMapperUI(MayaQWidgetDockableMixin, QtWidgets.QDialog):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("HumanIK映射器")
    ...
    def create_actions(self):
        ...
        self.bake_action = QtWidgets.QAction("烘焙")
        self.bake_timeline_action = QtWidgets.QAction("烘焙到时间线")
    ...
    def create_widgets(self):
        ...
        self.bake_menu = self.menu_bar.addMenu("烘焙")
        ...
        self.initialize_btn = QtWidgets.QPushButton("初始化")

        self.head_btn = QtWidgets.QPushButton("头部")
        self.spine_btn = QtWidgets.QPushButton("脊柱")

        self.left_arm_btn = QtWidgets.QPushButton("左臂")
        ...
        self.left_hand_btn = QtWidgets.QPushButton("左手")

        self.right_arm_btn = QtWidgets.QPushButton("右臂")
        ...
        self.right_hand_btn = QtWidgets.QPushButton("右手")

        self.left_leg_btn = QtWidgets.QPushButton("左腿")
        ...
        self.right_leg_btn = QtWidgets.QPushButton("右腿")
        ...
        self.mirror_checkbox = QtWidgets.QCheckBox("应用镜像")
        ...
        self.sub_ik_active_cb = QtWidgets.QCheckBox("子 IK 激活")
        ...
        self.batch_bake_layers_btn = QtWidgets.QPushButton("批量烘焙层")
        self.batch_bake_timeline_btn = QtWidgets.QPushButton("批量烘焙时间线")
    ...
    def create_layout(self):
        ...
        configure_gb = QtWidgets.QGroupBox("配置")
    ...
    def _change_bones_2_right(self, bones):
        ...
        for i in range(len(new_bones_list)):
            new_bones_list[i] = bones[i].replace("Left", "右侧")
