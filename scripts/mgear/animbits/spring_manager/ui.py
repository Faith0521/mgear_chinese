...
class SpringManager(MayaQWidgetDockableMixin, QtWidgets.QDialog, pyqt.SettingsMixin):
    ...
    def create_actions(self):
        # Bake actions
        self.bake_selected_action = QtWidgets.QAction("烘焙所选弹簧", self)
        self.bake_all_action = QtWidgets.QAction("烘焙所有弹簧", self)

        # Delete actions
        self.delete_selected_action = QtWidgets.QAction("删除所选弹簧", self)
        self.delete_all_action = QtWidgets.QAction("删除所有弹簧", self)

        # preset actions
        self.set_lib_action = QtWidgets.QAction("设置库路径", self)
        self.store_preset_action = QtWidgets.QAction("存储预设", self)
        self.refresh_presets_action = QtWidgets.QAction("刷新预设", self)
        self.delete_preset_action = QtWidgets.QAction("删除预设", self)
        # Select actions
        self.select_all_targets_action = QtWidgets.QAction("选择所有弹簧目标", self)
    ...
    def create_widgets(self):
        ...
        self.presets_menu = self.menu_bar.addMenu("预设")
        ...
        # directions
        self.directions_group_box = QtWidgets.QGroupBox("方向")
        ...
        self.search_le.setPlaceholderText("搜索过滤")
    ...
    def set_library(self, directory=None):
        ...
        self.presets_lib_directory_label.setText("库路径: {}".format(self.presets_library_directory))
    ...
    def _namespace_confirmation_dialogue(self, preset_namespace, selected_namespace):
        ...
        message_box.setWindowTitle("命名空间不匹配")
