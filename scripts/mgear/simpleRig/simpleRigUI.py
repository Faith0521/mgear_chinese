...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.createRoot_pushButton.setText(pyqt.fakeTranslate("MainWindow", "\u521b\u5efa\u6839\u8282\u70b9", None, -1))
        self.groupBox_3.setTitle(pyqt.fakeTranslate("MainWindow", "\u521b\u5efa\u63a7\u5236\u5668", None, -1))
        self.createCtl_pushButton.setText(pyqt.fakeTranslate("MainWindow", "\u521b\u5efa\u63a7\u5236\u5668", None, -1))
        self.label.setText(pyqt.fakeTranslate("MainWindow", "\u4fa7\u6807\u7b7e", None, -1))
        self.side_comboBox.setItemText(0, pyqt.fakeTranslate("MainWindow", "\u5c45\u4e2d", None, -1))
        self.side_comboBox.setItemText(1, pyqt.fakeTranslate("MainWindow", "\u5de6\u4fa7", None, -1))
        self.side_comboBox.setItemText(2, pyqt.fakeTranslate("MainWindow", "\u53f3\u4fa7", None, -1))
        self.label_3.setText(pyqt.fakeTranslate("MainWindow", "\u4f4d\u7f6e", None, -1))
        self.position_comboBox.setItemText(0, pyqt.fakeTranslate("MainWindow", "\u51e0\u4f55\u4f53\u4e2d\u5fc3", None, -1))
        self.position_comboBox.setItemText(1, pyqt.fakeTranslate("MainWindow", "\u51e0\u4f55\u4f53\u5e95\u90e8 (\u6700\u4f4eY\u8f74\u70b9)", None, -1))
        self.position_comboBox.setItemText(2, pyqt.fakeTranslate("MainWindow", "\u4e16\u754c\u4e2d\u5fc3", None, -1))
        self.label_2.setText(pyqt.fakeTranslate("MainWindow", "\u63a7\u5236\u5668\u5f62\u72b6", None, -1))
        self.shape_comboBox.setItemText(0, pyqt.fakeTranslate("MainWindow", "\u5706\u5f62", None, -1))
        self.shape_comboBox.setItemText(1, pyqt.fakeTranslate("MainWindow", "\u7acb\u65b9\u4f53", None, -1))
        self.groupBox_2.setTitle(pyqt.fakeTranslate("MainWindow", "\u7f16\u8f91", None, -1))
        self.groupBox_4.setTitle(pyqt.fakeTranslate("MainWindow", "\u5143\u7d20", None, -1))
        ...
        self.selectAffected_pushButton.setText(pyqt.fakeTranslate("MainWindow", "\u9009\u62e9\u53d7\u5f71\u54cd\u7684", None, -1))
        self.groupBox.setTitle(pyqt.fakeTranslate("MainWindow", "\u8f74\u5fc3", None, -1))
        self.editPivot_pushButton.setText(pyqt.fakeTranslate("MainWindow", "\u7f16\u8f91\u8f74\u5fc3", None, -1))
        self.setPivot_pushButton.setText(pyqt.fakeTranslate("MainWindow", "\u8bbe\u7f6e\u8f74\u5fc3", None, -1))
        self.reParentPivot_pushButton.setText(pyqt.fakeTranslate("MainWindow", "\u91cd\u65b0\u8bbe\u7f6e\u7236\u7ea7\u8f74\u5fc3", None, -1))
        self.groupBox_5.setTitle(pyqt.fakeTranslate("MainWindow", "\u81ea\u52a8\u7ed1\u5b9a", None, -1))
        self.suffix_label.setText(pyqt.fakeTranslate("MainWindow", "\u540e\u7f00\u89c4\u5219", None, -1))
        self.autoBuild_lineEdit.setText(pyqt.fakeTranslate("MainWindow", "geoRoot", None, -1))
        self.autoRig_pushButton.setText(pyqt.fakeTranslate("MainWindow", "\u81ea\u52a8\u6784\u5efa", None, -1))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.rig_tab), pyqt.fakeTranslate("MainWindow", "\u9aa8\u9abc", None, -1))
        self.groupBox_6.setTitle(pyqt.fakeTranslate("MainWindow", "\u6839\u8282\u70b9", None, -1))
        self.rootName_label.setText(pyqt.fakeTranslate("MainWindow", "\u6839\u540d\u79f0", None, -1))
        self.rootName_lineEdit.setText(pyqt.fakeTranslate("MainWindow", "root", None, -1))
        self.groupBox_8.setTitle(pyqt.fakeTranslate("MainWindow", "\u4e3b\u63a7\u5236\u5668 (\u4e16\u754c, \u5c40\u90e8, \u5168\u5c40)", None, -1))
        self.fixSize_checkBox.setText(pyqt.fakeTranslate("MainWindow", "\u4f7f\u7528\u56fa\u5b9a\u5927\u5c0f", None, -1))
        self.worldCenter_checkBox.setText(pyqt.fakeTranslate("MainWindow", "\u4e16\u754c\u4e2d\u5fc3\u7684\u4e3b\u63a7\u5236\u5668", None, -1))
        self.label_5.setText(pyqt.fakeTranslate("MainWindow", "\u5c40\u90e8/\u5168\u5c40\u63a7\u5236\u5668\u5f62\u72b6", None, -1))
        self.mainCtlShape_comboBox.setItemText(0, pyqt.fakeTranslate("MainWindow", "\u65b9\u5f62", None, -1))
        self.mainCtlShape_comboBox.setItemText(1, pyqt.fakeTranslate("MainWindow", "\u5706\u5f62", None, -1))
        self.label_4.setText(pyqt.fakeTranslate("MainWindow", "\u56fa\u5b9a\u5927\u5c0f", None, -1))
        self.label_6.setText(pyqt.fakeTranslate("MainWindow", "\u4e16\u754c\u63a7\u5236\u5668\u5f62\u72b6", None, -1))
        self.worldCtlShape_comboBox.setItemText(0, pyqt.fakeTranslate("MainWindow", "\u5706\u5f62", None, -1))
        self.worldCtlShape_comboBox.setItemText(1, pyqt.fakeTranslate("MainWindow", "\u7403\u4f53", None, -1))
        self.worldCtl_checkBox.setText(pyqt.fakeTranslate("MainWindow", "\u521b\u5efa\u4e16\u754c\u63a7\u5236\u5668", None, -1))
        self.groupBox_7.setTitle(pyqt.fakeTranslate("MainWindow", "\u81ea\u5b9a\u4e49\u96c6", None, -1))
        self.extraSets_label.setText(pyqt.fakeTranslate("MainWindow", "\u989d\u5916\u63a7\u5236\u5668\u96c6", None, -1))
        self.extraSets_lineEdit.setText(pyqt.fakeTranslate("MainWindow", "animSets.basic", None, -1))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.extraConfig_tab), pyqt.fakeTranslate("MainWindow", "\u989d\u5916\u914d\u7f6e", None, -1))
        self.menuIO.setTitle(pyqt.fakeTranslate("MainWindow", "\u6587\u4ef6", None, -1))
        self.menuConvert.setTitle(pyqt.fakeTranslate("MainWindow", "\u8f6c\u6362", None, -1))
        self.menuDelete.setTitle(pyqt.fakeTranslate("MainWindow", "\u5220\u9664", None, -1))
        self.menuAuto.setTitle(pyqt.fakeTranslate("MainWindow", "\u81ea\u52a8", None, -1))
        self.export_action.setText(pyqt.fakeTranslate("MainWindow", "\u5bfc\u51fa\u914d\u7f6e", None, -1))
        self.import_action.setText(pyqt.fakeTranslate("MainWindow", "\u5bfc\u5165\u914d\u7f6e", None, -1))
        self.convertToShifterRig_action.setText(pyqt.fakeTranslate("MainWindow", "\u8f6c\u6362\u4e3aShifter\u9aa8\u9abc", None, -1))
        self.createShifterGuide_action.setText(pyqt.fakeTranslate("MainWindow", "\u521b\u5efaShifter\u5f15\u5bfc", None, -1))
        self.deleteRig_action.setText(pyqt.fakeTranslate("MainWindow", "\u5220\u9664\u9aa8\u9abc", None, -1))
        self.deletePivot_action.setText(pyqt.fakeTranslate("MainWindow", "\u5220\u9664\u8f74\u5fc3", None, -1))
