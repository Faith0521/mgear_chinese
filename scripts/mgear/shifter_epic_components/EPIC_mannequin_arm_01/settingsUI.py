...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(pyqt.fakeTranslate("Form", "表单", None, -1))
        self.ikfk_label.setText(pyqt.fakeTranslate("Form", "IK/FK 混合", None, -1))
        self.maxStretch_label.setText(pyqt.fakeTranslate("Form", "最大拉伸", None, -1))
        self.divisions_label.setText(pyqt.fakeTranslate("Form", "分段", None, -1))
        self.ikTR_checkBox.setText(pyqt.fakeTranslate("Form", "IK 分离平移和旋转控制器", None, -1))
        self.mirrorIK_checkBox.setToolTip(pyqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.mirrorIK_checkBox.setStatusTip(pyqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.mirrorIK_checkBox.setWhatsThis(pyqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.mirrorIK_checkBox.setText(pyqt.fakeTranslate("Form", "镜像 IK 控制器轴行为", None, -1))
        self.mirrorMid_checkBox.setToolTip(pyqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.mirrorMid_checkBox.setStatusTip(pyqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.mirrorMid_checkBox.setWhatsThis(pyqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.mirrorMid_checkBox.setText(pyqt.fakeTranslate("Form", "镜像中间控制器和上方向量轴行为", None, -1))
        self.extraTweak_checkBox.setToolTip(pyqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.extraTweak_checkBox.setStatusTip(pyqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.extraTweak_checkBox.setWhatsThis(pyqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.extraTweak_checkBox.setText(pyqt.fakeTranslate("Form", "添加额外调整控制器", None, -1))
        self.TPoseRest_checkBox.setToolTip(pyqt.fakeTranslate("Form", "<html><head/><body><p>如果勾选，FK控制器的静止姿势将设为T姿势</p></body></html>", None, -1))
        self.TPoseRest_checkBox.setStatusTip(pyqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.TPoseRest_checkBox.setWhatsThis(pyqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.TPoseRest_checkBox.setText(pyqt.fakeTranslate("Form", "FK 休息 T 姿势", None, -1))
        self.useBlade_checkBox.setToolTip(pyqt.fakeTranslate("Form", "<html><head/><body><p>如果勾选，FK控制器的静止姿势将设为T姿势</p></body></html>", None, -1))
        self.useBlade_checkBox.setStatusTip(pyqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.useBlade_checkBox.setWhatsThis(pyqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.useBlade_checkBox.setText(pyqt.fakeTranslate("Form", "使用腕部刃片", None, -1))
        self.squashStretchProfile_pushButton.setText(pyqt.fakeTranslate("Form", "压缩和拉伸曲线", None, -1))
        self.ikRefArray_groupBox.setTitle(pyqt.fakeTranslate("Form", "IK 参考数组", None, -1))
        self.ikRefArray_copyRef_pushButton.setText(pyqt.fakeTranslate("Form", "从上方向量参考复制", None, -1))
        ...
        self.upvRefArray_groupBox.setTitle(pyqt.fakeTranslate("Form", "上方向量参考数组", None, -1))
        self.upvRefArray_copyRef_pushButton.setText(pyqt.fakeTranslate("Form", "从 IK 参考复制", None, -1))
        ...
        self.pinRefArray_groupBox.setTitle(pyqt.fakeTranslate("Form", "固定肘部参考数组", None, -1))
        self.pinRefArray_copyRef_pushButton.setText(pyqt.fakeTranslate("Form", "从 IK 参考复制", None, -1))
