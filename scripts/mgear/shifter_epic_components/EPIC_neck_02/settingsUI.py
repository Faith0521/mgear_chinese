...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.upvRefArray_groupBox.setTitle(QtWidgets.QApplication.translate("Form", "头部参考数组", None, -1))
        self.headRefArray_copyRef_pushButton.setText(QtWidgets.QApplication.translate("Form", "从 IK 参考复制", None, -1))
