...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.softness_label.setText(QtWidgets.QApplication.translate("Form", "柔软度", None, -1))
        self.softness_label_2.setText(QtWidgets.QApplication.translate("Form", "位置", None, -1))
        self.softness_label_3.setText(QtWidgets.QApplication.translate("Form", "锁定骨盆方向", None, -1))
        self.softness_label_4.setText(QtWidgets.QApplication.translate("Form", "锁定胸部方向", None, -1))
        self.maxStretch_label.setText(QtWidgets.QApplication.translate("Form", "最大拉伸", None, -1))
        self.maxSquash_label.setText(QtWidgets.QApplication.translate("Form", "最大挤压", None, -1))
        self.divisions_label.setText(QtWidgets.QApplication.translate("Form", "分段", None, -1))
        self.autoBend_label.setText(QtWidgets.QApplication.translate("Form", "自动弯曲控制", None, -1))
        self.autoBend_label_2.setText(QtWidgets.QApplication.translate("Form", "IK 控制器世界方向", None, -1))
        self.IKWorldOri_checkBox.setToolTip(QtWidgets.QApplication.translate("Form", "<html><head/><body><p>如果勾选，IK控制器将朝向世界空间的XYZ方向</p></body></html>", None, -1))
        self.centralTangent_label.setText(QtWidgets.QApplication.translate("Form", "中心切线", None, -1))
        self.squashStretchProfile_pushButton.setText(QtWidgets.QApplication.translate("Form", "压缩和拉伸曲线", None, -1))
        self.leafJoints_label.setText(QtWidgets.QApplication.translate("Form", "叶关节", None, -1))
