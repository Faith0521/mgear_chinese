...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.controlShape_label.setText("控制器形状")
    ...
    def retranslateUi(self, Form):
        ...
        self.joint_checkBox.setText(
            gqt.fakeTranslate("Form", "关节", None, -1)
        )
        ...
        self.leafJoint_checkBox.setText(
            gqt.fakeTranslate("Form", "是叶关节 (Beta)", None, -1)
        )
        self.uniScale_checkBox.setText(
            gqt.fakeTranslate("Form", "统一缩放", None, -1)
        )
        ...
        self.mirrorBehaviour_checkBox.setText(
            gqt.fakeTranslate("Form", "左右镜像行为", None, -1)
        )
        ...
        self.rbfLayers_label.setText(
            gqt.fakeTranslate("Form", "RBF层", None, -1)
        )
        self.ctlSize_label.setText(
            gqt.fakeTranslate("Form", "控制器大小", None, -1)
        )
        ...
        self.ikRefArray_groupBox.setTitle(
            gqt.fakeTranslate("Form", "IK 参考数组", None, -1)
        )
        ...
        self.keyable_groupBox.setTitle(
            gqt.fakeTranslate("Form", "可设关键帧", None, -1)
        )
        self.translate_pushButton.setText(
            gqt.fakeTranslate("Form", "位移", None, -1)
        )
        ...
        self.rotate_pushButton.setText(
            gqt.fakeTranslate("Form", "旋转", None, -1)
        )
        ...
        self.keyable_groupBox_2.setTitle(
            gqt.fakeTranslate("Form", "乘数", None, -1)
        )
        self.rbfLayers_label_3.setText(
            gqt.fakeTranslate("Form", "控制器旋转乘数", None, -1)
        )
        self.rbfLayers_label_4.setText(
            gqt.fakeTranslate("Form", "控制器缩放乘数", None, -1)
        )
        self.ctlTransMult_label.setText(
            gqt.fakeTranslate("Form", "控制器平移乘数", None, -1)
        )
