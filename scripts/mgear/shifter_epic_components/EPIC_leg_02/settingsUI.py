...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.ikfk_label.setText(QtWidgets.QApplication.translate("Form", "IK/FK 混合", None, -1))
        self.maxStretch_label.setText(QtWidgets.QApplication.translate("Form", "最大拉伸", None, -1))
        self.divisions_label.setText(QtWidgets.QApplication.translate("Form", "分段", None, -1))
        self.leafJoints_checkBox.setText(QtWidgets.QApplication.translate("Form", "叶关节", None, -1))
        self.mirrorMid_checkBox.setToolTip(QtWidgets.QApplication.translate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.mirrorMid_checkBox.setStatusTip(QtWidgets.QApplication.translate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.mirrorMid_checkBox.setWhatsThis(QtWidgets.QApplication.translate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.mirrorMid_checkBox.setText(QtWidgets.QApplication.translate("Form", "镜像中间控制器和上方向量轴", None, -1))
        ...
        self.TPoseRest_checkBox.setStatusTip(QtWidgets.QApplication.translate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.TPoseRest_checkBox.setWhatsThis(QtWidgets.QApplication.translate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.TPoseRest_checkBox.setText(QtWidgets.QApplication.translate("Form", "休息T姿势", None, -1))
        self.squashStretchProfile_pushButton.setText(QtWidgets.QApplication.translate("Form", "压缩和拉伸曲线", None, -1))
        self.ikRefArray_groupBox.setTitle(QtWidgets.QApplication.translate("Form", "IK 参考数组", None, -1))
        self.ikRefArray_copyRef_pushButton.setText(QtWidgets.QApplication.translate("Form", "从上方向量参考复制", None, -1))
        ...
        self.upvRefArray_groupBox.setTitle(QtWidgets.QApplication.translate("Form", "上方向量参考数组", None, -1))
        self.upvRefArray_copyRef_pushButton.setText(QtWidgets.QApplication.translate("Form", "从 IK 参考复制", None, -1))
        ...
        self.pinRefArray_groupBox.setTitle(QtWidgets.QApplication.translate("Form", "固定肘部参考数组", None, -1))
        self.pinRefArray_copyRef_pushButton.setText(QtWidgets.QApplication.translate("Form", "从 IK 参考复制", None, -1))
