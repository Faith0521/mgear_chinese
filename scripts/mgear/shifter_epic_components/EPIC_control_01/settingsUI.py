...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.descriptionName_checkBox.setText("使用自身名称作为关节描述名")
    ...
    def retranslateUi(self, Form):
        ...
        self.joint_checkBox.setText(gqt.fakeTranslate("Form", "关节", None, -1))
        self.uniScale_checkBox.setText(gqt.fakeTranslate("Form", "统一缩放", None, -1))
        self.neutralRotation_checkBox.setToolTip(gqt.fakeTranslate("Form", "<html><head/><body><p>如果激活，控制将与世界空间对齐</p></body></html>", None, -1))
        self.neutralRotation_checkBox.setText(gqt.fakeTranslate("Form", "世界空间方向对齐", None, -1))
        self.mirrorBehaviour_checkBox.setToolTip(gqt.fakeTranslate("Form", "<html><head/><body><p>如果激活，控制器将在左右两侧具有对称行为。</p><p><br/></p><p>警告：Maya 2018和2018.1中存在一个bug，会导致行为不正确，因为此选项会取反其中一个轴。其他Maya版本应该正常。</p></body></html>", None, -1))
        ...
        self.ctlSize_label.setText(gqt.fakeTranslate("Form", "控制器大小", None, -1))
        ...
        self.controlShape_comboBox.setItemText(14, gqt.fakeTranslate("Form", "Gear", None, -1))
        self.controlShape_comboBox.setItemText(15, gqt.fakeTranslate("Form", "mGear", None, -1))
        self.keyable_groupBox.setTitle(gqt.fakeTranslate("Form", "可设关键帧", None, -1))
        self.translate_pushButton.setText(gqt.fakeTranslate("Form", "位移", None, -1))
        ...
        self.rotate_pushButton.setText(gqt.fakeTranslate("Form", "旋转", None, -1))
        ...
        self.scale_pushButton.setText(gqt.fakeTranslate("Form", "缩放", None, -1))
        ...
        self.groupBox_4.setTitle(gqt.fakeTranslate("Form", "UE控制绑定设置", None, -1))
        ...
        self.label_2.setText(gqt.fakeTranslate("Form", "反向求解参考关节", None, -1))
