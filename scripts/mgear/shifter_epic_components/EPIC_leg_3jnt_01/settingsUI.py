...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.ikSolver_label.setText(QtWidgets.QApplication.translate("Form", "IK求解器", None, -1))
        self.ikSolver_comboBox.setItemText(0, QtWidgets.QApplication.translate("Form", "IK弹簧", None, -1))
        self.ikSolver_comboBox.setItemText(1, QtWidgets.QApplication.translate("Form", "旋转平面", None, -1))
        self.full3bonesIK_label.setText(QtWidgets.QApplication.translate("Form", "完整三骨骼IK", None, -1))
        self.leafJoints_checkBox.setText(QtWidgets.QApplication.translate("Form", "叶关节", None, -1))
        self.neutralRotation_checkBox.setText(QtWidgets.QApplication.translate("Form", "世界空间方向对齐IK控制器", None, -1))
