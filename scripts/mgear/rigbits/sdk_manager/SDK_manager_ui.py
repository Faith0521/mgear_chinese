...
class SDKManagerDialog(MayaQWidgetDockableMixin, QtWidgets.QDialog):
    ...
    def create_menu_bar_actions(self):
        ...
        """
        # File
        self.export_SDKs_action = QtWidgets.QAction("导出 SDK", self)
        self.import_SDKs_action = QtWidgets.QAction("导入 SDK", self)
        ...
        # Tools
        self.tgl_pre_infinity_action = QtWidgets.QAction("帧前无限", self)
        self.tgl_pst_infinity_action = QtWidgets.QAction("帧后无限", self)
    ...
    def clear_ui(self):
        ...
        """
        self.ui.Driver_pushButton.setText("驱动")
        self.driver = None
