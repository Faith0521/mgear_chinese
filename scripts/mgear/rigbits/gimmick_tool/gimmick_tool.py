...
"}")
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QtWidgets.QApplication.translate("MainWindow", "辅助关节设置工具", None, -1))
        self.creation_grpupBox.setTitle(QtWidgets.QApplication.translate("MainWindow", "辅助关节创建", None, -1))
        self.blendJoint_pushButton.setText(QtWidgets.QApplication.translate("MainWindow", "混合关节", None, -1))
        self.supportJoint_pushButton.setText(QtWidgets.QApplication.translate("MainWindow", "支撑关节", None, -1))
        self.mirrorGimmick_pushButton.setText(QtWidgets.QApplication.translate("MainWindow", "镜像辅助关节", None, -1))
        self.utility_groupBox.setTitle(QtWidgets.QApplication.translate("MainWindow", "实用工具", None, -1))
        self.utility_all_checkBox.setText(QtWidgets.QApplication.translate("MainWindow", "全部:", None, -1))
        self.utility_left_checkBox.setText(QtWidgets.QApplication.translate("MainWindow", "左侧", None, -1))
        self.utility_center_checkBox.setText(QtWidgets.QApplication.translate("MainWindow", "中间", None, -1))
        self.utility_right_checkBox.setText(QtWidgets.QApplication.translate("MainWindow", "右侧", None, -1))
        self.select_pushButton.setText(QtWidgets.QApplication.translate("MainWindow", "选择", None, -1))
        self.delete_pushButton.setText(QtWidgets.QApplication.translate("MainWindow", "删除", None, -1))
        self.flipJoint_groupBox.setTitle(QtWidgets.QApplication.translate("MainWindow", "翻转关节(支撑)", None, -1))
        ...
        self.menuFile.setTitle(QtWidgets.QApplication.translate("MainWindow", "文件", None, -1))
        self.importGimmick_menuAction.setText(QtWidgets.QApplication.translate("MainWindow", "导入辅助关节数据", None, -1))
        self.exportGimmick_menuAction.setText(QtWidgets.QApplication.translate("MainWindow", "导出辅助关节数据", None, -1))
