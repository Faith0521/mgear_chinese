...
class WireToSkinningUI(
    ...
    def create_widgets(self):
        ...
        # Dropoff distance
        self.dropoff_label = QtWidgets.QLabel("衰减距离:")
        ...
        # Wire name
        self.wire_name_label = QtWidgets.QLabel("线框名称:")
        self.wire_name_input = QtWidgets.QLineEdit()
        self.wire_name_input.setText("wire")
        self.wire_name_input.setPlaceholderText("线框变形器名称")

        # Create button
        self.create_wire_btn = QtWidgets.QPushButton("创建线框变形器")
        ...
        self.refresh_btn = QtWidgets.QPushButton("刷新线框列表")

        # =================================================================
        # SECTION 2: CONVERT TO SKIN
        # =================================================================
        self.convert_section = CollapsibleWidget(
            "2. 转换为蒙皮集群", expandable=False
        )

        # Wire selection
        self.wire_select_label = QtWidgets.QLabel("线框变形器:")
        self.wire_combo = QtWidgets.QComboBox()
        self.wire_combo.setMinimumWidth(200)

        # Convert all checkbox
        self.convert_all_cb = QtWidgets.QCheckBox("转换所有线框变形器")

        # Joint creation options
        self.joint_group = QtWidgets.QGroupBox("关节选项")
        ...
        self.joint_prefix_label = QtWidgets.QLabel("关节前缀:")
        self.joint_prefix_input = QtWidgets.QLineEdit()
        self.joint_prefix_input.setText("wire_jnt")

        # Parent joint
        self.parent_joint_label = QtWidgets.QLabel("父级关节:")
        ...
        # Static joint
        self.static_joint_label = QtWidgets.QLabel("静态关节:")
        ...
        # Convert button
        self.convert_btn = QtWidgets.QPushButton("转换为蒙皮集群")
