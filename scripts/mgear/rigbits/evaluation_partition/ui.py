...
class EvaluationPartitionUI(
    ...
    def create_widgets(self):
        ...
        # Action buttons
        self.execute_btn = QtWidgets.QPushButton("执行分区")
        ...
        # Status label
        self.status_label = QtWidgets.QLabel("选择网格开始")
    ...
    def create_layout(self):
        ...
        # Target mesh section
        mesh_group = QtWidgets.QGroupBox("目标网格")
        ...
        groups_group = QtWidgets.QGroupBox("多边形组")
    ...
    def on_mesh_changed(self):
        ...
        self.toggle_shaders_btn.setText("显示原始着色器")
    ...
    def update_face_count(self):
        ...
        if self.group_manager:
            ...
            self.face_count_label.setText("总面数: -")
    ...
    def toggle_shaders(self):
        ...
        try:
            ...
            if self.group_manager.showing_partitions:
                ...
                self.toggle_shaders_btn.setText("显示分区着色器")
