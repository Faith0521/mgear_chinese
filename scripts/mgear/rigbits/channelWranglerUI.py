...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.channelMapping_tableWidget.horizontalHeaderItem(1).setText(pyqt.fakeTranslate("Form", "通道", None, -1))
        self.channelMapping_tableWidget.horizontalHeaderItem(2).setText(pyqt.fakeTranslate("Form", "Source", None, -1))
        self.channelMapping_tableWidget.horizontalHeaderItem(3).setText(pyqt.fakeTranslate("Form", "目标", None, -1))
        ...
        self.groupBox.setTitle(pyqt.fakeTranslate("Form", "通道", None, -1))
        self.channel_pushButton.setText(pyqt.fakeTranslate("Form", "<<<", None, -1))
        self.groupBox_2.setTitle(pyqt.fakeTranslate("Form", "目标", None, -1))
        ...
        self.groupBox_3.setTitle(pyqt.fakeTranslate("Form", "移动复制通道策略", None, -1))
