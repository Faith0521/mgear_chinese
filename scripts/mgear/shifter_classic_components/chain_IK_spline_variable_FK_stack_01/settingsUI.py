...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.isGlobalMaster_checkBox.setText("仅IK全局主控(无FK控制器和关节)")
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox_3.setTitle(gqt.fakeTranslate("Form", "FK控制器", None, -1))
        self.fkNb_label.setText(gqt.fakeTranslate("Form", "FK控制器数量", None, -1))
        ...
        self.groupBox_4.setTitle(gqt.fakeTranslate("Form", "链主控制器", None, -1))
        ...
        self.jntNb_label_3.setText(gqt.fakeTranslate("Form", "连接偏移", None, -1))
