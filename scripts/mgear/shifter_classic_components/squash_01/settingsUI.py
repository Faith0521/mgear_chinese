...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox.setTitle(QtWidgets.QApplication.translate("Form", "挤压/拉伸乘数", None, -1))
        self.squashX_label.setText(QtWidgets.QApplication.translate("Form", "挤压X", None, -1))
        self.squashY_label.setText(QtWidgets.QApplication.translate("Form", "挤压Y", None, -1))
        self.squashZ_label.setText(QtWidgets.QApplication.translate("Form", "挤压Z", None, -1))
        self.stretchX_label.setText(QtWidgets.QApplication.translate("Form", "拉伸X", None, -1))
        self.stretchY_label.setText(QtWidgets.QApplication.translate("Form", "拉伸Y", None, -1))
        self.stretchZ_label.setText(QtWidgets.QApplication.translate("Form", "拉伸Z", None, -1))
        self.upvRefArray_groupBox.setTitle(QtWidgets.QApplication.translate("Form", "末端参考数组", None, -1))
