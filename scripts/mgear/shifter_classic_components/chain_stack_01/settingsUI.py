...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.overrideJntNb_checkBox.setText("覆盖关节数量")
        ...
        self.simpleFK_checkBox.setText("简单FK，无关节")
        ...
        self.keepLength_checkBox.setText("保持长度")
        ...
        self.extraTweak_checkBox.setText("额外调整")
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox_2.setTitle(gqt.fakeTranslate("Form", "关节选项", None, -1))
        self.jntNb_label.setText(gqt.fakeTranslate("Form", "关节数量", None, -1))
        self.groupBox_3.setTitle(gqt.fakeTranslate("Form", "链主控制器", None, -1))
        self.label_3.setText(gqt.fakeTranslate("Form", "全局:", None, -1))
        self.masterGlobal_pushButton.setText(gqt.fakeTranslate("Form", "<<", None, -1))
        self.label.setText(gqt.fakeTranslate("Form", "局部:", None, -1))
        self.masterLocal_pushButton.setText(gqt.fakeTranslate("Form", "<<", None, -1))
        self.jntNb_label_2.setText(gqt.fakeTranslate("Form", "连接偏移", None, -1))
        ...
        self.groupBox_4.setTitle(gqt.fakeTranslate("Form", "可见性UI宿主", None, -1))
        self.label_2.setText(gqt.fakeTranslate("Form", "可见性宿主", None, -1))
