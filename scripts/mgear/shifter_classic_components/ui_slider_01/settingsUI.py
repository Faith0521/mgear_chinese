...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QtWidgets.QApplication.translate("Form", "左右镜像行为", None, -1))
        self.mirror_behaviour_checkbox.setToolTip(QtWidgets.QApplication.translate("Form", "<html><head/><body><p>如果激活，控制器将在左右两侧具有对称行为。</p><p><br/></p><p>警告：Maya 2018和2018.1中存在一个bug，会导致行为不正确，因为此选项会取反其中一个轴。其他Maya版本应该正常。</p></body></html>", None, -1))
        self.control_size_label.setText(QtWidgets.QApplication.translate("Form", "控制器大小", None, -1))
        self.keyable_groupBox.setTitle(QtWidgets.QApplication.translate("Form", "运动范围", None, -1))
        self.negative_label.setText(QtWidgets.QApplication.translate("Form", "负值", None, -1))
        self.positive_label.setText(QtWidgets.QApplication.translate("Form", "正值", None, -1))
        self.translate_x_label.setText(QtWidgets.QApplication.translate("Form", "平移X", None, -1))
        self.translate_y_label.setText(QtWidgets.QApplication.translate("Form", "平移Y", None, -1))
