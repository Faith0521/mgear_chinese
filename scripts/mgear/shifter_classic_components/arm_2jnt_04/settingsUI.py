...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.ikfk_label.setText(gqt.fakeTranslate("Form", "FK/IK 混合", None, -1))
        self.maxStretch_label.setText(gqt.fakeTranslate("Form", "最大拉伸", None, -1))
        self.maxStretch_label_2.setText(gqt.fakeTranslate("Form", "肘部厚度", None, -1))
        self.divisions_label.setText(gqt.fakeTranslate("Form", "分段", None, -1))
        self.ikTR_checkBox.setText(gqt.fakeTranslate("Form", "IK 分离平移和旋转控制器", None, -1))
        self.mirrorIK_checkBox.setToolTip(gqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.mirrorIK_checkBox.setStatusTip(gqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.mirrorIK_checkBox.setWhatsThis(gqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.mirrorIK_checkBox.setText(gqt.fakeTranslate("Form", "镜像 IK 控制器轴行为", None, -1))
        self.mirrorMid_checkBox.setToolTip(gqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.mirrorMid_checkBox.setStatusTip(gqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.mirrorMid_checkBox.setWhatsThis(gqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.mirrorMid_checkBox.setText(gqt.fakeTranslate("Form", "镜像中间控制器和上方向量轴行为", None, -1))
        self.extraTweak_checkBox.setToolTip(gqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.extraTweak_checkBox.setStatusTip(gqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.extraTweak_checkBox.setWhatsThis(gqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.extraTweak_checkBox.setText(gqt.fakeTranslate("Form", "添加额外调整控制器", None, -1))
        self.supportJoints_checkBox.setToolTip(gqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.supportJoints_checkBox.setStatusTip(gqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.supportJoints_checkBox.setWhatsThis(gqt.fakeTranslate("Form", "设置中间控制器(肘部)和上方向向量控制器以镜像方式移动的轴行为 ", None, -1))
        self.supportJoints_checkBox.setText(gqt.fakeTranslate("Form", "支撑肘部关节", None, -1))
        self.guideOrientWrist_checkBox.setToolTip(gqt.fakeTranslate("Form", "此选项将腕部与引导对齐。注意：此选项将覆盖镜像IK控制器行为", None, -1))
        self.guideOrientWrist_checkBox.setStatusTip(gqt.fakeTranslate("Form", "此选项将腕部与引导对齐。", None, -1))
        self.guideOrientWrist_checkBox.setWhatsThis(gqt.fakeTranslate("Form", "此选项将腕部与引导对齐。", None, -1))
        self.guideOrientWrist_checkBox.setText(gqt.fakeTranslate("Form", "将腕部对齐到引导方向", None, -1))
        self.squashStretchProfile_pushButton.setText(gqt.fakeTranslate("Form", "压缩和拉伸曲线", None, -1))
        self.ikRefArray_groupBox.setTitle(gqt.fakeTranslate("Form", "IK 参考数组", None, -1))
        self.ikRefArray_copyRef_pushButton.setText(gqt.fakeTranslate("Form", "从上方向量参考复制", None, -1))
        ...
        self.upvRefArray_groupBox.setTitle(gqt.fakeTranslate("Form", "上方向量参考数组", None, -1))
        self.upvRefArray_copyRef_pushButton.setText(gqt.fakeTranslate("Form", "从 IK 参考复制", None, -1))
        ...
        self.pinRefArray_groupBox.setTitle(gqt.fakeTranslate("Form", "固定肘部参考数组", None, -1))
        self.pinRefArray_copyRef_pushButton.setText(gqt.fakeTranslate("Form", "从 IK 参考复制", None, -1))
