...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.softness_label.setText(gqt.fakeTranslate("Form", "柔软度", None, -1))
        self.softness_label_2.setText(gqt.fakeTranslate("Form", "位置", None, -1))
        self.softness_label_3.setText(gqt.fakeTranslate("Form", "锁定方向", None, -1))
        self.maxStretch_label.setText(gqt.fakeTranslate("Form", "最大拉伸", None, -1))
        self.maxSquash_label.setText(gqt.fakeTranslate("Form", "最大挤压", None, -1))
        self.divisions_label.setText(gqt.fakeTranslate("Form", "分段", None, -1))
        self.autoBend_label.setText(gqt.fakeTranslate("Form", "自动弯曲控制", None, -1))
        self.centralTangent_label.setText(gqt.fakeTranslate("Form", "中心切线", None, -1))
        self.IKWorldOri_checkBox.setToolTip(gqt.fakeTranslate("Form", "<html><head/><body><p>如果勾选，IK控制器将朝向世界空间的XYZ方向</p></body></html>", None, -1))
        self.autoBend_label_2.setText(gqt.fakeTranslate("Form", "IK 控制器世界方向", None, -1))
