...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QtWidgets.QApplication.translate("表单", "表单", None, -1))
        self.control_size_label.setText(QtWidgets.QApplication.translate("Form", "控制器大小", None, -1))
        self.control_label.setText(QtWidgets.QApplication.translate("Form", "创建控制器", None, -1))
        self.groupBox_2.setTitle(QtWidgets.QApplication.translate("Form", "UI设置", None, -1))
        self.margin_label.setText(QtWidgets.QApplication.translate("Form", "边框边距", None, -1))
