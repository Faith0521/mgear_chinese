...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.joint_checkBox.setText(QtWidgets.QApplication.translate("Form", "关节", None, -1))
        self.uniScale_checkBox.setText(QtWidgets.QApplication.translate("Form", "统一缩放", None, -1))
        self.neutralRotation_checkBox.setToolTip(QtWidgets.QApplication.translate("Form", "<html><head/><body><p>如果激活，控制将与世界空间对齐</p></body></html>", None, -1))
        self.neutralRotation_checkBox.setText(QtWidgets.QApplication.translate("Form", "世界空间方向对齐", None, -1))
        self.mirrorBehaviour_checkBox.setToolTip(QtWidgets.QApplication.translate("Form", "<html><head/><body><p>如果激活，控制器将在左右两侧具有对称行为。</p><p><br/></p><p>警告：Maya 2018和2018.1中存在一个bug，会导致行为不正确，因为此选项会取反其中一个轴。其他Maya版本应该正常。</p></body></html>", None, -1))
        self.mirrorBehaviour_checkBox.setText(QtWidgets.QApplication.translate("Form", "左右镜像行为", None, -1))
        self.customPivot_checkBox.setText(QtWidgets.QApplication.translate("Form", "自定义轴心", None, -1))
        self.ctlSize_label.setText(QtWidgets.QApplication.translate("Form", "控制器大小", None, -1))
        ...
        self.keyable_groupBox.setTitle(QtWidgets.QApplication.translate("Form", "可设关键帧", None, -1))
        self.translate_pushButton.setText(QtWidgets.QApplication.translate("Form", "位移", None, -1))
        ...
        self.rotate_pushButton.setText(QtWidgets.QApplication.translate("Form", "旋转", None, -1))
        ...
        self.scale_pushButton.setText(QtWidgets.QApplication.translate("Form", "缩放", None, -1))
